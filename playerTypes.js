...
},
{
    ...
    evasion: 40,
    tags: ['player'],
    thumbnail: 'Media/Classes/Mod/MTGMOD.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    level: 0,
    isLocked: false,
    abilities: [],
},
{
    ...
    evasion: 40,
    tags: ['player'],
    thumbnail: 'Media/Classes/Mod/FTGMOD.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    level: 0,
    isLocked: false,
    abilities: [],
},
{
    class: 'Survivor',
    title: 'Permabull',
    description: 'Eternally optimistic about the market, always expecting prices to go up. They are relentless in their belief and often influence others to stay positive.',
    tooltip: '',
    health: 3,
    movementspeed: 0.2,
    xp: 0,
    evasion: 20,
    tags: ['player'],
    thumbnail: 'Media/Classes/Permabull/MPERMABULL.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    level: 0,
    isLocked: false,
    abilities: [],
    ...
    evasion: 20,
    tags: ['player'],
    thumbnail: 'Media/Classes/Permabull/FPERMABULL.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    level: 0,
    isLocked: false,
    abilities: [],
},
{
    class: 'Survivor',
    title: 'Permabear',
    description: 'Consistently cautious and prepared for the worst, Permabears expect market downturns and protect their assets with vigilance, often profiting in bearish markets.',
    tooltip: '',
    health: 4,
    movementspeed: 0.2,
    xp: 0,
    evasion: 25,
    tags: ['player'],
    thumbnail: 'Media/Classes/Permabear/MPERMABEAR.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    level: 0,
    isLocked: false,
    abilities: [],
