...
},
{
    ...
    evasion: 45,
    tags: ['player'],
    thumbnail: 'Media/Classes/Oracle/MORACLE.png', 
    geometry: new THREE.BoxGeometry(1, 1, 1),
    material: createNeonMaterial(rainbowColors[colorIndex]),
    level: 0,
    isLocked: false,
...
},
{
    class: 'Survivor',
    title: 'NFT Artist',
    description: 'Enthusiast creator of digital collectibles, focused on art, utility, and ownership within the blockchain.',
    tooltip: '',    
    health: 1,
    movementspeed: 0.2,
    xp: 0,
