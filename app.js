...
},
{
    ...
    class: 'Survivor',
    title: 'Defi Hacker',
    description: 'Drains protocols, exploiting vulnerabilities for personal gain',
    tooltip: '',    
    health: 1,
    movementspeed:0.2,
    xp: 0,
...
},
{
    ...
    description: 'Focused on maximizing mining efficiency, Industrial Miners excel in dealing high damage over a short period',
    tooltip: '',    
    health: 1,
    movementspeed:0.2,
    xp: 0,
    evasion: 50,
    tags: ['player'],
    thumbnail: 'Media/Classes/Industrial Miner/MINDUSTRIALMINER.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    material: createNeonMaterial(rainbowColors[colorIndex]),
    level:0,
    isLocked: false, 
    ...
    evasion: 50,
    tags: ['player'],
    thumbnail: 'Media/Classes/Industrial Miner/FINDUSTRIALMINER.png',
    geometry: new THREE.BoxGeometry(1, 1, 1),
    material: createNeonMaterial(rainbowColors[colorIndex]),
    level:0,
    isLocked: false, 
